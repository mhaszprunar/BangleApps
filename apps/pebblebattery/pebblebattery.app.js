...
function loadSettings() {
  settings = require("Storage").readJSON(SETTINGS_FILE,1)|| {'bg': '#0f0', 'color': 'Green', "showBatteryNumber":true,"refresh":15};
}
...
function draw() {
  ...
  batteryWarning = (bl <= 15) ? true : false;
...
loadSettings();
setInterval(draw, settings.refresh*1000);
draw();
Bangle.setUI("clock");
